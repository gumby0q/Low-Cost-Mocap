...
export default function ThreeCameraWireframe({R, t, toWorldCoordsMatrix}: {R: Array<Array<number>>, t: Array<number>, toWorldCoordsMatrix: number[][]}) {
  const vertices = [
    [0,0,0],
    [1,0.85,1],
    [-1,0.85,1],
  ...
  // console.log("toWorldCoordsMatrix", toWorldCoordsMatrix)
  ...
  const _lineSegments = new LineSegments(wireframeGeo, mat);
